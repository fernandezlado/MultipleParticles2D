MODULE modOperators
  ...
  TYPE intOperator
     ...
     COMPLEX(8),DIMENSION(:,:),ALLOCATABLE::matSL
     COMPLEX(8),DIMENSION(:,:),ALLOCATABLE::matDL
...
CONTAINS  
  ...
  SUBROUTINE createMatrices(this,op_flags,k_ext,k_int)
    ...
    IF ( op_flags(1) ) THEN
       ...
       ALLOCATE (this % matSL (0:N_i-1, 0:N_i-1 ) )
       ...
       this % matSL = 2 * Pi / N_i * K_r + MK_Weights * K_s 
    ...
    IF ( op_flags(2) ) THEN
       ...
       ALLOCATE (this % matDL (0:N_i-1, 0:N_i-1) )
       ...
       this % matDL = 2 * Pi / N_i * K_r + MK_Weights * K_s
  ...
  SUBROUTINE destroyOperator (this)
    ...
    DEALLOCATE(this % matSL, this % matDL)
